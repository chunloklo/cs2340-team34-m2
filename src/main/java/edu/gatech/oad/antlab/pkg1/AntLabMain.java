 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Jiseok Choi");
		  toPrint += p1.toString("jchoi483");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Matthew Wang");
		  toPrint += p2.toString("mwang400");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Alan Li");
		  toPrint += p3.toString("ali311");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Matthew Kaufer");
                  toPrint += p4.toString("mkaufer3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Chunlok Lo");
                  toPrint += p5.toString("clo42");
